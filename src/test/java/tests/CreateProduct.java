...
public class CreateProduct extends BaseTest {
    ...
    public void testCreateProduct(ITestContext context){
       ...
       assertActions.verifyResponseBody((String) apiActions.getDataFromJsonPath(response, "title"), "Pikachu sneakers", "The title isn't right.");
       assertActions.verifyResponseBody(apiActions.getDataFromJsonPath(response, "price"), 500, "The price isn't right.");
        assertActions.verifyResponseBody((String) apiActions.getDataFromJsonPath(response, "description"), "Sneakers Adult Cosplay Pikachu", "The description isn't right.");
